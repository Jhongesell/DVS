...
protected:
   ...
   gmm::csr_matrix<double> MapInt;
   gmm::csr_matrix<double> MapFull;

#ifdef SIN_PRECONDICIONADOR
   gmm::identity_matrix PR;
#else
   gmm::ildltt_precond<gmm::csr_matrix<double> > S_PR_MapInt;
   gmm::ildltt_precond<gmm::csr_matrix<double> > S_PR_MapFull;
   gmm::ildltt_precond<gmm::csr_matrix<double> > NS_PR_MapInt;
   gmm::ildltt_precond<gmm::csr_matrix<double> > NS_PR_MapFull;
#endif

   //~ gmm::diagonal_precond<gmm::csr_matrix<double> > PR;
   //~ gmm::ildltt_precond<gmm::csr_matrix<double> > PR;
   //~ gmm::ilut_precond<gmm::csr_matrix<double> > PR;
   //~ gmm::ilutp_precond<gmm::csr_matrix<double> > PR;
#else
...
public:
   ...
   void genInverse(int *map, ldouble fac, int ind);
