...
/// Clase para definir el metodo MF-1 de DVS-DDM
/** Clase para definir el metodo MF-1 de DVS-DDM en paralelo
*/
...
*/
class PLM2MPI: public DPMainMPI, public  PLM2
{
...
public:
   ...
   PLM2MPI(int id, int np, PropDef &props, EllipOp &op) : DPMainMPI(id, np, props, op), PLM2(props, op)
   {
   }
   ...
   {
      DPMainMPI::ce.nameClassFunct("PLM2MPI", "iniInterchage");
