...
/// Clase para definir el metodo LM-1 de DVS-DDM
/** Clase para definir el metodo LM-1 de DVS-DDM en paralelo
*/
...
*/
class LM1MPI: public DPMainMPI, public  LM1
{
...
public:
   ...
   LM1MPI(int id, int np, PropDef &props, EllipOp &op) : DPMainMPI(id, np, props, op), LM1(props, op)
   {
   }
   ...
   {
      DPMainMPI::ce.nameClassFunct("LM1MPI", "iniInterchage");
