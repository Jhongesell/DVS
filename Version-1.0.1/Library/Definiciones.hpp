...
#define NMAXITER 200                  // Iteraciones en metodos globales
...
#define EPSILON_LOCAL (EPSILON/1e+2)  // Tolerancia en metodos locales
...
//                                                                                            //
//                                                                                            //
// Los metodos directos para los calculos en los subdominio consumen una mayor cantidad de    //
// RAM, pero aumentan la velocidad de ejecución y precision en los calculos cuando las mallas //
// locales son relalitivamente burdas menores a 220x220.
...
// descomposiciones de dominio finas (subdominios mas finos de 220x220)                       //
