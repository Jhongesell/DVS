...
*/
class MF1MPI: public DPMainMPI, public  MF1
{
...
public:
   ...
   MF1MPI(int id, int np, PropDef &props, EllipOp &op) : DPMainMPI(id, np, props, op), MF1(props, op)
   {
   }
   ...
   {
      DPMainMPI::ce.nameClassFunct("MF1MPI", "iniInterchage");
