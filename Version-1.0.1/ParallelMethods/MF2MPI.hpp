...
/// Clase para definir el metodo MF-2 de DVS-DDM
/** Clase para definir el metodo MF-2 de DVS-DDM en paralelo
*/
...
*/
class MF2MPI: public DPMainMPI, public  MF2
{
...
public:
   ...
   MF2MPI(int id, int np, PropDef &props, EllipOp &op) : DPMainMPI(id, np, props, op), MF2(props, op)
   {
   }
   ...
   {
      DPMainMPI::ce.nameClassFunct("MF2MPI", "iniInterchage");
